...
public class astraDBHelper {
    ...
    public static String userDetailsNoSlash = region + "/v2/keyspaces/learntogether/userdetails";
    public static String meetupsUrl = region + "/v2/keyspaces/learntogether/meetups/";
